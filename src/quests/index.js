...
const questList = {
  BOX1: {
    ...
    color: "#1168df",
    imgPath: "3box.png",
    badgeImgPath: "3BOX-101-badge.svg",
    category: "Profile",
  ...
  BOX2: {
    ...
    color: "#1168df",
    imgPath: "3box.png",
    badgeImgPath: "3BOX-102-badge.svg",
    category: "Profile",
    categoryColor: "#4c6ae0",
    prerequisite: "",
    points: 400,
  ...
  MKR4: {
    ...
    color: "#1aaa9b",
    imgPath: "makerdao.png",
    badgeImgPath: "MKR-104-badge.svg",
    category: "Finance",
    categoryColor: "#8DFBC9",
    prerequisite: "",
    points: 500,
  ...
  NEXUS1: {
    ...
    color: "#60D3A2",
    imgPath: "nexus.jpg",
    badgeImgPath: "NEXUS-101-badge.svg",
    category: "Finance",
    categoryColor: "#8DFBC9",
    prerequisite: "",
    points: 250,
  ...
  UNI1: {
    ...
    resource: "https://uniswap.exchange/swap",
    platform: "Uniswap",
    color: "#DC6BE5",
    imgPath: "uniswap.png",
  ...
  UNI2: {
    ...
    resource: "https://uniswap.exchange/add-liquidity",
    platform: "Uniswap",
    color: "#DC6BE5",
    imgPath: "uniswap.png",
